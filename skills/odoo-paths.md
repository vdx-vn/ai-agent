...
5. Command will ask for docs root, source root, and version if auto-detection fails, then write `.odoo-skills/project.json` and `.claude/odoo-skill-paths.json` for this project.
